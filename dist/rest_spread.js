...
var timedeFutebolDeRj = ['vasco', 'flamengo', 'fluminense', 'botafogo'];

// const timedeFutebol = timedeFutebolDeSp.concat(timedeFutebolDeRj);
var timedeFutebol = [].concat(timedeFutebolDeSp, timedeFutebolDeRj);
...
var _timedeFutebol = _toArray(timedeFutebol),
  item1 = _timedeFutebol[0],
  item2 = _timedeFutebol[1],
  item3 = _timedeFutebol[2],
  outrosTimes = _timedeFutebol.slice(3);
console.log(item1);
console.log(item2);
console.log(item3);
